...
// Import encryption functions from AES implementation
import { encryptImage, decryptImage } from "../security/aes_encryption";

const EncryptedIPFSUploader = () => {
  ...
  const PINATA_API_KEY = "6322d3113f84f82aab77";
  const PINATA_SECRET_API_KEY =
    "80ff7df33d65df6bd9e1f51f8df414fd1a25680c0ce464b6ee1b5553db334691";
  ...
  const downloadAndDecrypt = async (hash, originalName) => {
    if (!encryptionKey) {
      setError("Please enter your encryption key to decrypt the file");
      return;
    }
    ...
    try {
      ...
      // Decrypt the file
      const decryptedBlob = await decryptImage(encryptedBlob, encryptionKey);
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 py-12">
                  ...
                  <div className="flex">
                    <div className="flex-shrink-0">
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z"
                          clipRule="evenodd"
                        />
                      </svg>
                    </div>
                    <div className="ml-3">
                      <p className="text-sm text-yellow-700">
                        <span className="font-medium">Remember:</span> You'll
                        need to enter your encryption key above to decrypt
                        files. We don't store your key - if you forget it, your
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          <p>SecureIPFS - End-to-end encrypted decentralized storage</p>
          <p className="mt-1">
            Your files are encrypted in your browser before upload. No one but
            you can access them.
          </p>
        </div>
      </div>
...
export default EncryptedIPFSUploader;
